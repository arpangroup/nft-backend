...
public class RankDataInitializer {
    ...
    public void init() {
        ...
        RankConfig rank1 = new RankConfig(RANK_1, 50, 100);

        // Rank 2: Level A = 3, Level B = 4, Level C = 1
        RankConfig rank2 = new RankConfig(RANK_2, 500, 2000);
        ...
        RankConfig rank3 = new RankConfig(RANK_3, 2000, 5000);
        ...
        RankConfig rank4 = new RankConfig(RANK_4, 5000, 10000);
