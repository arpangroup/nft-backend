...
@Slf4j
public class Rank3Evaluation implements RankEvaluationStrategy {
    ...
    public boolean isEligible(Long userId, RankEvaluationContext context) {
        RankConfig config = rankConfigRepository.findById(Rank.RANK_3)
                .orElseThrow(() -> new IllegalStateException("Rank config not found for RANK_3"));
